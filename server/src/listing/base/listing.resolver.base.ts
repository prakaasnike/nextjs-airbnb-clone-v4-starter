...
export class ListingResolverBase {
  ...
  async createListing(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        listingCreadtedBy: {
          connect: args.data.listingCreadtedBy,
        },
      },
    });
  }
  ...
  async resolveFieldListingCreadtedBy(
    @graphql.Parent() parent: Listing
  ): Promise<User | null> {
    const result = await this.service.getListingCreadtedBy(parent.id);
